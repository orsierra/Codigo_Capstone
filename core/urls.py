...
urlpatterns = [
    ...
    path('alumno_detalle/<int:establecimiento_id>/<int:curso_id>/<int:alumno_id>/', views.alumno_detalle, name='alumno_detalle'),
    path('alumno_detalle/<int:establecimiento_id>/<int:curso_id>/<int:alumno_id>/descargar_pdf/', descargar_pdf_alumno, name='descargar_pdf_alumno'),
